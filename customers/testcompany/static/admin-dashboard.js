...
async function editUser(userId) {
    try {
        ...
        if (user) {
            ...
            const operatorElement = document.getElementById('user-operator');
            const semiOperatorElement = document.getElementById('user-semi-operator');
            
            if (operatorElement) operatorElement.checked = user.operator || false;
            if (semiOperatorElement) semiOperatorElement.checked = user.semi_operator || false;
