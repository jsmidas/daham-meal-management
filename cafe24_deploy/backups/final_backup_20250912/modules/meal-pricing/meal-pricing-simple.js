...
window.MealPricingModule = {
    ...
    displayMealPlans() {
        ...
        this.mealPlans.forEach((plan, index) => {
            html += `
                <div class="meal-plan-card" style="border: 1px solid #ddd; margin: 10px 0; padding: 15px; border-radius: 5px;">
                    <div class="meal-plan-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                    ...
                    <div class="meal-plan-details">
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
                            <div>
                                <label style="display: block; margin-bottom: 5px; font-weight: bold;">식사 시간:</label>
                        ...
                        <div style="margin-top: 10px; padding: 10px; background-color: #f8f9fa; border-radius: 3px;">
                            <small style="color: #666;">
                                재료비 비율: ${plan.selling_price > 0 ? ((plan.target_material_cost / plan.selling_price) * 100).toFixed(1) : 0}%
                                ${plan.selling_price > 0 && (plan.target_material_cost / plan.selling_price) > 0.4 ? 
                                    ' <span style="color: #dc3545;">⚠️ 재료비 비율이 높습니다</span>' : ''}
                            </small>
                        </div>
                    </div>
                </div>
