...
window.SitesModule = {
    ...
    showAddSiteModal(siteType = null, parentId = null) {
        ...
        // 체크박스 라벨 특별 스타일 적용
        const checkboxLabels = modal.querySelectorAll('.checkbox-label');
        ...
        console.log('모달 CSS 강제 적용 완료:', modal.style.cssText);
    ...
    async editSite(siteId) {
        try {
            ...
            if (data.success && data.site) {
                ...
                console.log('편집 모달 CSS 강제 적용 완료:', modal.style.cssText);
