    ...
    try:
        ...
        for site in all_sites:
            sites_list.append({
                ...
                "contact_person": site.contact_person if site.contact_person else "",
                "contact_phone": site.contact_phone if site.contact_phone else "",
...
async def get_sites_tree(db: Session = Depends(get_db)):
    ...
    try:
        ...
        all_sites = db.query(Customer).order_by(Customer.level, Customer.sort_order).all()
